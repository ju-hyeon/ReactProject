        ...
        <div className="flex flex-col w-screen-full m-6">
            ...
            <div className="overflow-hidden">
                ...
                <table className="min-w-full mb-6 text-center">
                    ...
                    <tr>
                        <td className="border px-5 py-4 whitespace-nowrap text-sm font-bold text-gray-800 bg-indigo-50 my-8">Client Name
                            <span className='text-sm text-red-500 font-bold'>*</span>
                        </td>
                        <td className="border px-5 py-4 whitespace-nowrap text-sm text-gray-800">
                            <input type="text"
                                   value={contents.clientName}
                                   className="flex w-full py-2 px-3 border border-gray-200 rounded-md text-sm mr-4"
                                   placeholder="Client Name을 입력하세요."
                                   onChange={(e) => handleChangeData("clientName", e.target.value)}
                            />
                        </td>

                        <td className="border px-5 py-4 whitespace-nowrap text-sm text-gray-800 font-bold bg-indigo-50 my-8">Sold To Name</td>
                        <td className="border px-5 py-4 whitespace-nowrap text-right text-sm">
                            <input type="text"
                                   value={category}
                                   className="flex w-full py-2 px-3 border border-gray-200 rounded-md text-sm mr-4"
                    ...
                    <tr>
                        <td className="border px-5 py-4 whitespace-nowrap text-sm font-bold text-gray-800 bg-indigo-50 my-8">Ship To Name</td>
                        <td className="border px-5 py-4 whitespace-nowrap text-sm text-gray-800">
                            <input type="text"
                                   value={contents.shipToName}
                                   className="flex w-full py-2 px-3 border border-gray-200 rounded-md text-sm mr-4"
                                   placeholder="Ship To Name을 입력하세요."
                                   onChange={(e) => handleChangeData("shipToName", e.target.value)}
                            />
                        </td>
